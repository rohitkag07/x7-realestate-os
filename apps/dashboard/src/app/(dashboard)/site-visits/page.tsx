  ...
  return (
    <>
      <PageHeader
        ...
        description="Weekly planning, demo slots, callbacks, and post-appointment feedback for conversion-ready leads."
        actions={<Button size="sm"><CalendarPlus className="h-4 w-4 mr-2" /> Appointment Calendar</Button>}
      />
