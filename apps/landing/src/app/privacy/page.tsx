export const metadata = {
  ...
  description: 'Privacy Policy for X7 WhatsAI Assistant',
};
  ...
  return (
    <main className="min-h-screen bg-[#f7f3ea] px-5 py-12 text-[#1b2a29]">
      <article className="mx-auto max-w-3xl rounded-lg bg-white p-6 shadow-sm ring-1 ring-black/10 md:p-10">
        <p className="text-sm font-bold uppercase tracking-[0.2em] text-[#0d7d67]">X7 WhatsAI Assistant</p>
        ...
        <section className="mt-8 space-y-4 text-sm leading-7 text-[#33413f]">
          <p>
            X7 WhatsAI Assistant helps businesses respond to customer enquiries on WhatsApp, qualify leads,
